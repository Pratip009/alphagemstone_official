    ...
    >
      ...
      <div className="flex flex-col flex-1 px-[22px] pt-[22px] pb-[26px]">
        ...
        <span
          ...
          style={{ fontFamily: "'Cinzel', serif", color: '#7a6a52', fontWeight: 500 }}
        >
          — {item.num}
        </span>
...
export default function GemsPromise() {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;1,300;1,400;1,500&family=Cinzel:wght@400;500;600&family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&display=swap');
      `}</style>
        ...
        <div className="relative w-full px-6 sm:px-10 md:px-14 lg:px-20 py-16 sm:py-22 md:py-28">
          ...
          <div ref={headingRef} className="mb-14 sm:mb-18 md:mb-20">
            ...
            >
              ...
              <span
                ...
                style={{ fontFamily: "'Cinzel', serif", color: '#c9a84c', fontWeight: 500 }}
              >
                Our Promise
              </span>
              <div
          ...
          >
            <span
              ...
              style={{ fontFamily: "'Cinzel', serif", color: '#7a6a50', fontWeight: 500 }}
            >
              Certified by
            </span>
