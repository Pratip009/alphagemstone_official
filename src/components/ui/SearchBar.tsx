...
export default function SearchBar({
  ...
  return (
    <>
      <style>{`
        .sb-wrap { position: relative; font-family: "Google Sans Flex", sans-serif; }
        .sb-input-row {
        ...
        .sb-sec-label {
          ...
          font-family: "Google Sans Flex", sans-serif; position: sticky; top: 0;
        ...
        .sb-meta { font-size: 11px; color: #9f9fc0; font-family: "Google Sans Flex", sans-serif; margin-top:1px; }
        .sb-badge {
        ...
        .sb-chip {
          ...
          font-weight: 500; font-family: "Google Sans Flex", sans-serif;
        ...
        .sb-hint { font-size: 11px; color: #b0aecb; font-family: "Google Sans Flex", sans-serif; }
        .sb-all {
        ...
        .sb-empty { padding: 28px 20px; text-align: center; font-size: 13px; color: #9f9fc0; font-family: "Google Sans Flex", sans-serif; }
                        ...
                        return (
                          <div key={kind}>
                            <div style={{
                              ...
                              color: "#b0aecb", fontFamily: '"Google Sans Flex", sans-serif',
                            }}>
                              {KIND_LABELS[k]}
