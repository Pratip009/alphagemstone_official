...
const css = `
  .ap-root { font-family: "Google Sans Flex", sans-serif; color: #0f172a; background: #f8f7f4; min-height: 100vh; padding: 2rem; }
  .ap-root * { box-sizing: border-box; }

  .ap-display { font-family: "Google Sans Flex", sans-serif; font-size: 1.75rem; color: #0f172a; letter-spacing: -0.02em; }
  ...
  .ap-section-title { font-family: "Google Sans Flex", sans-serif; font-size: 1.1rem; color: #0f172a; margin: 0 0 1.25rem; padding-bottom: 0.75rem; border-bottom: 1px solid #e2e0da; }
  ...
  .ap-input { width: 100%; height: 40px; padding: 0 0.875rem; border: 1.5px solid #d1cec7; border-radius: 8px; font-family: "Google Sans Flex", sans-serif; font-size: 0.875rem; color: #0f172a; background: #fafaf8; transition: border-color 0.15s, box-shadow 0.15s; outline: none; }
  ...
  .ap-btn-primary { display: inline-flex; align-items: center; gap: 0.4rem; padding: 0 1.25rem; height: 40px; background: #0f172a; color: #fff; border: none; border-radius: 8px; font-family: "Google Sans Flex", sans-serif; font-size: 0.825rem; font-weight: 600; letter-spacing: 0.03em; cursor: pointer; transition: background 0.15s, transform 0.1s; }
  ...
  .ap-btn-ghost { display: inline-flex; align-items: center; gap: 0.4rem; padding: 0 1.1rem; height: 40px; background: transparent; color: #475569; border: 1.5px solid #d1cec7; border-radius: 8px; font-family: "Google Sans Flex", sans-serif; font-size: 0.825rem; font-weight: 500; cursor: pointer; transition: all 0.15s; }
  .ap-btn-ghost:hover { border-color: #b45309; color: #b45309; background: #fef3c7; }

  .ap-btn-danger { display: inline-flex; align-items: center; gap: 0.4rem; padding: 0 1.1rem; height: 40px; background: transparent; color: #dc2626; border: 1.5px solid #fca5a5; border-radius: 8px; font-family: "Google Sans Flex", sans-serif; font-size: 0.825rem; font-weight: 600; cursor: pointer; transition: all 0.15s; }
  ...
  .ap-type-btn { flex: 1; height: 38px; border: none; border-radius: 7px; font-family: "Google Sans Flex", sans-serif; font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: all 0.18s; color: #64748b; background: transparent; display: flex; align-items: center; justify-content: center; gap: 0.4rem; }
  ...
  .ap-pill { padding: 4px 11px; border-radius: 20px; border: 1.5px solid #d1cec7; font-size: 0.75rem; font-weight: 500; color: #475569; background: #fff; cursor: pointer; transition: all 0.12s; font-family: "Google Sans Flex", sans-serif; }
  ...
  .ap-deactivate { font-size: 0.75rem; color: #94a3b8; background: none; border: none; cursor: pointer; font-family: "Google Sans Flex", sans-serif; padding: 4px 8px; border-radius: 6px; transition: all 0.15s; white-space: nowrap; }
  .ap-deactivate:hover { color: #d97706; background: #fef3c7; }
  .ap-delete-row { font-size: 0.75rem; color: #94a3b8; background: none; border: none; cursor: pointer; font-family: "Google Sans Flex", sans-serif; padding: 4px 8px; border-radius: 6px; transition: all 0.15s; display: inline-flex; align-items: center; gap: 3px; white-space: nowrap; }
  ...
  .ap-clear-btn { font-size: 0.78rem; color: #b45309; background: none; border: none; cursor: pointer; font-family: "Google Sans Flex", sans-serif; font-weight: 600; padding: 0; }
  ...
  .ap-page-btn { width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border: 1.5px solid #d1cec7; border-radius: 6px; font-size: 0.78rem; font-weight: 500; color: #475569; background: #fff; cursor: pointer; transition: all 0.12s; font-family: "Google Sans Flex", sans-serif; }
  ...
  .ap-empty-title { font-family: "Google Sans Flex", sans-serif; font-size: 1.1rem; color: #0f172a; margin-bottom: 0.4rem; }
  ...
  .ap-modal-title { font-family: "Google Sans Flex", sans-serif; font-size: 1.15rem; color: #0f172a; margin: 0 0 0.5rem; }
  ...
  .ap-modal-confirm-input { width: 100%; height: 38px; padding: 0 0.75rem; border: 1.5px solid #d1cec7; border-radius: 7px; font-family: "Google Sans Flex", sans-serif; font-size: 0.875rem; color: #0f172a; background: #fafaf8; outline: none; transition: border-color 0.15s; }
  ...
  .ap-modal-cancel { flex: 1; height: 40px; background: #f8f7f4; border: 1.5px solid #d1cec7; border-radius: 8px; font-family: "Google Sans Flex", sans-serif; font-size: 0.825rem; font-weight: 500; color: #475569; cursor: pointer; transition: all 0.15s; }
  .ap-modal-cancel:hover { border-color: #94a3b8; background: #f1f0ec; }
  .ap-modal-confirm-btn { flex: 1; height: 40px; background: #dc2626; border: none; border-radius: 8px; font-family: "Google Sans Flex", sans-serif; font-size: 0.825rem; font-weight: 600; color: #fff; cursor: pointer; transition: background 0.15s; }
